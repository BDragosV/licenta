...
class Application(tk.Tk):
    ...
    def create_header_frame(self):
        ...
        self.button1=tk.Button(self.tab1, image=self.photo1 ,bg='#BFEFFF', bd=0,width = 140, command=self.handle_sinus)
        ...
        self.button2=tk.Button(self.tab2, image=self.photo1,bg='#BFEFFF', bd=0,width = 140)
        ...
        self.button3=tk.Button(self.tab3, image=self.photo1,bg='#BFEFFF', bd=0,width = 140 ,command=self.start_square)
